# RailsAdmin config file. Generated on October 15, 2012 13:10
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Photosite', 'Admin']
  ...
  # config.excluded_models = ['Image', 'User']

  # Include specific models (exclude the others):
  # config.included_models = ['Image', 'User']
